...
const STRINGS = {
  'zh-TW': {
    ...
    'nlEdit.outOfRange': 'AI 指定的星期或節次超出目前課表範圍。',
    'nlEdit.missingSubject': 'AI 沒有指定要修改成的科目名稱。',
    'nlEdit.emptySource': '要搬移或對調的節次目前是空的，沒有課可以搬移或對調。',
    'nlEdit.tooManyOps': '這句指令包含的修改項目太多，請分成幾次描述。',
    'nlEdit.opPrefix': '第 {n} 項：',
